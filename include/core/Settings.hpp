...
namespace ORB_SLAM3 {
    ...
    public:
         ...
         */
        // R4c: scoped enum; the re-export keeps Settings::PinHole sites valid.
        ...
        // R4c: noncopyable (owns the calibration objects it news up).
        ...
        bool fastInit() const {return fastInit_;}
