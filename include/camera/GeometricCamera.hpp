...
namespace ORB_SLAM3 {
    ...
    public:
        ...
        // Model-specific keypoint undistortion for two-view reconstruction
        // (P3-3: the reconstruction orchestration itself moved to
        // geometry/TwoViewInitializer; identity for models whose keypoints
        // are already undistorted upstream).
        virtual std::vector<cv::KeyPoint> UndistortKeyPoints(const std::vector<cv::KeyPoint>& vKeys) { return vKeys; }
