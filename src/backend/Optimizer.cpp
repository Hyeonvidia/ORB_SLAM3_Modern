...
void Optimizer::LocalBundleAdjustment(KeyFramePtr pMainKF,vector<KeyFramePtr> vpAdjustKF, vector<KeyFramePtr> vpFixedKF, const std::atomic<bool> *pbStopFlag, const BAEpochs& epochs)
{
